    ...
    <div class="col-md-6 col-11">
        <div class="panel">
          <h4 style="font-family: Raleway, sans-serif; text-align: center;"><b>CHECK KESEHATAN</b></h4>
            <hr>
            <h4 style="font-family: 'Roboto Slab', serif; text-align: left;">1. Apakah Anda mengalami salah satu dari berikut:</h4>
              <ul style="font-family: 'Lato', sans-serif; font-size: 14px; text-align: left;">
                  ...
                  <li>
                      <h6>Sulit untuk bangun</h6>
                  </li>
                  <li>
                      <h6>Merasa kebingungan</h6>
                  </li>
                  <li>
                      <h6>Penurunan kesadaran</h6>
                  </li>
                  <li>
                      <h6>Sakit tenggorokan yang parah</h6>
                  </li>
              </ul>
